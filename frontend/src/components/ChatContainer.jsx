...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  //this function will make bt default scroll end
  useEffect(() => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop:blur-lg">
      ...
      {/* chat area */}
      <div className="flex flex-col overflow-y-scroll h-[calc(100%-120px)] p-3 pb-6">
        {/* show the dummy data for now */}
    ...
    <div className="flex items-center justify-center gap-4 max-md:hidden">
      ...
      <p className="text-white text-lg">Chat anytime, anywhere</p>
    </div>
  );
};
